...
public class KthsmallestinBST extends SearchNInsertBST {
	...
	private static int KthsmallestinBST(Node root,int k) {
		int nums[] = new int[2];
	...
	public static void main(String[] args) {
        ...
        System.out.println(KthsmallestinBST(tree.root,2));
